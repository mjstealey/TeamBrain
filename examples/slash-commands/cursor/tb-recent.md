...
# /tb-recent — list recent TeamBrain memories
...
Then:
1. Treat the human's argument as an optional row limit — a bare integer sets `limit`
   (cap 100); otherwise use the default 20.
